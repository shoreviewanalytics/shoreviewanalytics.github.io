...
Apache Tomcat® is an open source implementation of Java Servlet, JavaServer Pages, Java Expression Language and Java WebSocket technologies. This guide explains how to setup Apache Tomcat® 9 on Ubuntu 18.04 and essentially follows the same steps that you can find in other posted tutorials (see references below) .  

The main difference with this post is that it clarifies the security problems that can occur when trying to access the Server Status, Manager App and the Host Application pages from the Tomcat home page after an initial install.  If your are facing the access denied issue as shown in the following image, you can safely skip down to Steps 6 to 8 below.  



![](/media/sf_PNY480/jekyllsite/shoreviewanalytics.github.io/assets/images/credentials.png)





If your doing a fresh install of Tomcat 9 on Ubuntu 18.04, you will want to go through all steps.  
